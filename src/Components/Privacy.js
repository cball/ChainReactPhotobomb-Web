...
export default () => {
  return (
    <div className="privacyPolicy">
      ...
      <p>
        Echobind built the Chain React Photobomb app as a Free app. This SERVICE
        is provided by Echobind at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Chain React Photobomb
      ...
      <p>
        ...
        but not limited to Photos. The information that we request is will be
